...
\calculusName{Polarized Linear Logic}   % The name of the calculus
...
\entryTitle{Polarized Linear Logic}     % Title of the entry (usually coincides with the name of the calculus).
