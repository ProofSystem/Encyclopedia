...
\[ \infer[weakening\quad (x\not\in\Gamma)]{\Gamma, x : A \entails M : B}{\Gamma \entails M : B \quad \Gamma \entails A : s} \]
\[ \infer[product\quad (s_1,s_2,s_3)\in\rules]{\Gamma \entails \Pi x : A. B : s_3}{\Gamma \entails A : s_1 \quad \Gamma, x : A \entails B : s_2} \]
\[ \infer[abstraction]{\Gamma \entails \lambda x: A. M : \Pi x : A. B}{\Gamma, x : A \entails M : B \quad \Gamma \entails \Pi x : A. B : s} \]
\[ \infer[application]{\Gamma \entails M~N : B[x \coloneqq N]}{\Gamma \entails M : \Pi x : A. B \quad \Gamma \entails N : A} \]
\[ \infer[conversion]{\Gamma \entails M : B}{\Gamma \entails M : A \quad \Gamma \entails B : s \quad A \equiv_\beta B} \]
