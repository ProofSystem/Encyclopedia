...
\calculusName{Resolution for Modal Logics}   % The name of the calculus
...
\entryTitle{Resolution for Modal Logics (\RK)}     % Title of the entry (usually coincides with the name of the calculus).
