...
\begin{clarifications}
  The succedent of every sequent has exactely one formula.
...
\begin{history}
  ...
  The sequent calculus for the intuitionistic multiplicative linear logic (IMLL) \cite{mints1977closed}
  is the restriction to the structural and multiplicative rules.
\end{history}
