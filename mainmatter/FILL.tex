...
\entryTitle{Full Intuitionistic Linear Logic}        % Title of the entry (usually coincides with the name of the calculus).
...
%% another proof system that is not yet available in the encyclopedia.
  ...
  in her thesis \cite{dePaiva:1988}.  The improvement was the addition
...
%%   dialectica categories \cite{dePaiva:1988}.
%% \end{technicalities}
