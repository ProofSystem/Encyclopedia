...
\noindent
2. {\bf Desequentialization map:} \qquad $(\AxiomC{$\vdash \overline{A, A^{\bot}}$}\DisplayProof)^-$ 
...
\noindent
3. $\mathcal{R}_1(R_1, L_1)$ is a \emph{subnet} of  $\mathcal{R}_2(R_2, L_2)$ if 
$R'\subseteq R$ and  $L_1$ = $L_2 |_{R_1}$. 

\vspace{1ex}

\noindent
3.2. {\bf Lemma 1.} Let $\mathcal{R}_1$ and $\mathcal{R}_2$ be subnets of $\mathcal{R}$
...
\noindent
3.3. The {\bf empire} $eA$, for $A\in \mathcal{R}$, 
...
\noindent
3.4 The \emph{kingdom} $kA$ of $A$ is the \emph{smallest} subnet having $A$ 
as a conclusion. 
