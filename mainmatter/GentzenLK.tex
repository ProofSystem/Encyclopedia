...
% be very concise and objective.
 ...
 \begin{history}
This is Gentzen's original formulation\cite{Gentzen1934} where the term language has only free and bound variables. A version adding individual and function constants is given in Takeuti's ``Proof Theory''\cite{Takeuti1975}. An invertible variant of \LK is $\LK'$\irefmissing{LKprime}, an intuitionistic version is \LJ\irefmissing{GentzenLJ}. 
\end{history}
