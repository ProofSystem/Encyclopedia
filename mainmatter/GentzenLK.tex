...
\begin{history}
This is a modern presentation of Gentzen's original \LK calculus\cite{lk:Gentzen1935}, using modern notations and rule names. Originally, names of free and bound variables were disjoint. Additionally, the hole notation was originally represented by a meta-variable.
\end{history}
