...
% be very concise and objective.
 ...
 \begin{history}
This is Gentzen's original formulation\cite{lk:Gentzen1935}, Takeuti\cite{lk:Takeuti1975} has a bit more modern presentation. An invertible variant of \LK is $\LK'$\irefmissing{LKprime}, an intuitionistic version is \LJ\iref{SequentCalculusLJ}. 
\end{history}
