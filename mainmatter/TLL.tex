\calculusName{Two-sided Linear Logic}   % The name of the calculus
...
\entryTitle{Two-sided Linear Logic}        % Title of the entry (usually coincides with the name of the calculus).
\entryAuthor{Elaine Pimentel} % Your name(s). Separate multiple names with "\and".
