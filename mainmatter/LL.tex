...
\calculusName{Linear Logic}   % The name of the calculus
\calculusAcronym{\LL}    % The acronym if defined above, or empty otherwise. 
\calculusLogic{Linear Logic}  % Specify the logic (e.g. classical, intuitionistic, ...) for which this calculus is intended.
...
\calculusYear{1986}   % The year when the calculus was invented.
\calculusAuthor{Jean-Yves Girard} % The name(s) of the author(s) of the calculus.


\entryTitle{Linear Logic}     % Title of the entry (usually coincides with the name of the calculus).
