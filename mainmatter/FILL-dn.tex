...
\entryTitle{FILL Deep Nested Sequent Calculus~\cite{DBLP:conf/csl/CloustonDGT13}}     % Title of the entry (usually coincides with the name of the calculus).
\entryAuthor{Rajeev Gor\'e}    % Your name(s). Separate multiple names with "\and".
