...
$s = \lambda\vc x n.x_i(\overline{y_l(\vc x n)})$ for $0<i\leq n$ and $l = \texttt{ar}(x_i)$.
\end{calculus}
 ...
 \begin{clarifications}
  ...
  $\texttt{ar}(a)$ denotes the arity of the symbol $a$.
 ...
 \begin{history}
   ...
   be non-redundant and more efficient.
...
The set $S$ is considered
  ...
  The application of the first three rules is deterministic, that of the last two rules is
