\calculusName{Sequent Calculus for Logic of Partial Quasiary Predicates}         % The name of the calculus
\calculusAcronym{QE-calculus}          % The acronym if defined above, or empty otherwise. 
\calculusLogic{Extended Logic of Partial Quasiary Predicates}        % Specify the logic (e.g. Classical Logic, Intuitionistic Logic, ...) for which this calculus is intended.
...
\calculusYear{2017}         % The year when the calculus was published.

\calculusAuthor{Mykola Nikitchenko}       % The name(s) of the author(s) of the calculus.
\calculusAuthor{Stepan Skilniak}



\entryTitle{Sequent Calculus for Logic of Partial Quasiary Predicates}     % Title of the entry (usually coincides with the name of the calculus).
