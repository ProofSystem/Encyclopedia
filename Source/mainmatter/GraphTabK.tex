...
\calculusYear{1997}
\calculusAuthor{Marcos A. Castilho}
\calculusAuthor{Luis Fari\~nas del Cerro}
\calculusAuthor{Olivier Gasquet}
\calculusAuthor{Andreas Herzig}



%
\entryTitle{Graph-based tableaux for modal logics}
\entryAuthor{Joseph Boudou} \entryAuthor{Olivier Gasquet}
...
\begin{clarifications}
  ...
  to add, as detailed in Table~\ref{tab:GraphTabK}.
