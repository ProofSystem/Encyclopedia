...
\calculusAuthor{\iCA{Laura Giordano}, \iCA{Valentina Gliozzi}, \iCA{Nicola Olivetti}, \iCA{Gian Luca Pozzato}} % The name(s) of the author(s) of the calculus.


\entryTitle{Preferential Tableau Calculi \calcoloP}     % Title of the entry (usually coincides with the name of the calculus).
\entryAuthor{\iA{Laura Giordano}, \iA{Valentina Gliozzi}, \iA{Nicola Olivetti}, \iA{Gian Luca Pozzato}}     
