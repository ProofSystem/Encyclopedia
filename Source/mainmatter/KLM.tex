...
\calculusAuthor{Laura Giordano} \calculusAuthor{Valentina Gliozzi} \calculusAuthor{Nicola Olivetti} \calculusAuthor{Gian Luca Pozzato} % The name(s) of the author(s) of the calculus.
