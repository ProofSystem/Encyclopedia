...
\begin{history}
   ...
   and by Gould \cite{guard1964automated} (where it is called matching).
...
\begin{technicalities}
  ...
  The application of the above rules and the choice
 of which equation to process are deterministic (up to renaming of free variables).
 \end{technicalities}
