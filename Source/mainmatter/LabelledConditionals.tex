...
%
 ...
 \begin{history}
  The calculi SeqS have been introduced in~\cite{toclpozz}. The theorem prover
  CondLean, implementing SeqS calculi in Prolog, has been presented
  in~\cite{tab2003pozz,tab2005pozz}.
 \end{history}
