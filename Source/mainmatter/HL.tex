...
\cite{Brauner01c} and developed in \cite{Brauner01b}. A natural deduction system for intuitionistic hybrid logic can be found in the entry \iref{IHL}. These and other natural deduction systems are also included in the book \cite{Brauner11a}, which considers a spectrum of different versions of hybrid logic
