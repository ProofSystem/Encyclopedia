...
\cite{Brauner01c} and developed in \cite{Brauner01b}. The system satisfies normalization, and normal derivations satisfy a version of the subformula property. Completeness is preserved when the system is extended with additional rules corresponding to first-order conditions on Kripke frames expressed by geometric theories. A natural deduction system for intuitionistic hybrid logic can be found in the entry \iref{IHL}. These natural deduction systems are also included in the book \cite{Brauner11a}, which considers a spectrum of different versions of hybrid logic
