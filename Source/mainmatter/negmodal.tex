...
Also, the logics that are induced by these systems enjoy the replacement property,
which is missing in various other logics that employ a non-classical negation.
 \end{technicalities}
