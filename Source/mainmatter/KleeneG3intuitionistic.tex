...
\calculusName{Kleene's Intuitionistic $\Gthree$}   % The name of the calculus
...
\entryTitle{Kleene's Intuitionistic $\Gthree$ System}     % Title of the entry (usually coincides with the name of the calculus).
...
\tag{Asymmetric Sequents}
\tag{Single-succedent Sequents}
...
% ToDo: write here remarks about soundness, completeness, decidability...
  ...
  % Used together with its multi-conclusion version for classical
  % logic~\iref{KleeneG3classical} to uniformly obtain decidability for
  % propositional classical and intuitionistic logic via backwards
  % proof search in~\cite{Kleene:1952}.
\end{technicalities}
