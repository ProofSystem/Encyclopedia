...
\calculusAuthor{Olaf Beyersdorff}
\calculusAuthor{Leroy Chew}
\calculusAuthor{Mikol\'{a}\v{s} Janota } 


\entryTitle{IR} 
\entryAuthor{Leroy Chew}
\entryAuthor{Mikol\'{a}\v{s} Janota} 
\maketitle
