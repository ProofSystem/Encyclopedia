...
\begin{calculus}
\scalebox{0.97}{$\begin{array}{@{\quad\quad}l@{\quad\quad}l@{\quad\quad}l@{\quad\quad}l@{\quad\quad}l@{\quad}l@{\quad}l@{\quad}} 
...
Update logic  is a (proper) display calculus. It  enjoys  cut elimination and  is decidable. %It is sound and complete 
 \end{technicalities}
