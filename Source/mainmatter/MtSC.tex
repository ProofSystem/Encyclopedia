...
\calculusAuthor{Apostolos Tzimoulis} 
\calculusAuthor{Zhiguang Zhao} 
\calculusAuthor{Minghui Ma} 
...
\begin{technicalities}
  ...
  multi-type display calculi, see for instance semi DeMorgan logic~\iref{MtDSDM},
  inquisitive logic~\iref{MtDInqL}, lattice logic~\iref{MtDLatL}, dynamic
  epistemic logic~\iref{MtDDEL}, linear logic~\cite{GrecoPalmigiano}, and
  propositional dynamic logic. %~\cite{FrittellaGrecoKurzPalmigiano2016}. 
  The logic of resources and capabilities %~\cite{BilkovaGrecoPalmigianoTzimoulisWijnberg} 
