...
$\GBK\left[B\right]$ is the calculus obtained from the propositional fragment of $\LK$ (\iref{GentzenLK}) by deleting the left rule of negation, and adding the rules $R(x)$ for every $x\in B$, as well as  the following rules:
\footnotesize$
