...
%
% The following entries should be moved to their 
% chronologically correct position after final acceptance.
...
\includeProofSystem{MtDLatL}
\includeProofSystem{MtDDEL}
\includeProofSystem{MtDSDM}
\includeProofSystem{UpdateLogic} % 2016
\includeProofSystem{EpsilonCalculus} % 1939
